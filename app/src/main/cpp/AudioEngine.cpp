...
const SampleMetadata& AudioEngine::getPadMetadata(int padIndex) const {
    static SampleMetadata empty;
    if (padIndex < 0 || padIndex >= MAX_PADS) return empty;
    return mPadMetadata[padIndex];
}
